			...
			<div class="login-box">
				<div class="login-input-box">
					...
					<div class="login-box-button-box">
						...
						<a href="/user/lost/loginId-view"><button type="button" class="link-find-id">아이디 찾기</button></a>
						<a href="/user/lost/password-view"><button type="button" class="link-find-password">비밀번호 찾기</button></a>
					</div>
				</div>
			</div>
		</div>
