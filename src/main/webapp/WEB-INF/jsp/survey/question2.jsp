...
<body>
			...
			<div class="survey-question-box-center">
				<div class="survey-question-box">
					<div class="survey-question-number-end">
						<div class="survey-question-number">2/5</div>
					</div>
					
					<div class="survey-question-text-center">
						<div class="survey-question-text">
							<div class="survey-question-text1">칫솔질 할 때</div>
							<div class="survey-question-text2">불소치약을 사용하고 있나요?</div>
						</div>				
					</div>
	...
	$(document).ready(function(){
		$("#surveyNextBtn").on("click", function(){
			...
			location.href = "/survey/question3-view" + parameter + "&fluorideToothpaste=" + fluorideToothpaste
		});
	});
	</script>
</body>
